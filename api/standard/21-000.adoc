...
:titletext: OGC API - Routes - Part 1: Core
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/is/ogcapi-routes-1/1.0.0-draft.1
|Internal reference number of this OGC(R) document:    21-000
